...
const globalMediaConcurrencyStore = globalThis as typeof globalThis & {
    __venLinksMediaConcurrency?: { totals: Map<string, number>; identities: Map<string, number> };
};

const counters = (globalMediaConcurrencyStore.__venLinksMediaConcurrency ??= { totals: new Map(), identities: new Map() });

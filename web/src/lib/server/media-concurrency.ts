...
const globalMediaConcurrencyStore = globalThis as typeof globalThis & {
    __venLinksProMediaConcurrency?: { totals: Map<string, number>; identities: Map<string, number> };
};

const counters = (globalMediaConcurrencyStore.__venLinksProMediaConcurrency ??= { totals: new Map(), identities: new Map() });

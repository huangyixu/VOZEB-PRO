...
describe("GET /api/auth/data-export", () => {
    beforeEach(() => {
        ...
        mocks.buildUserDataExport.mockResolvedValue({ format: "venlinks-personal-data", version: 1 });
    });
    ...
    it("returns a private JSON download for the current user", async () => {
        ...
        expect(response.headers.get("content-disposition")).toContain("venlinks-personal-data-");

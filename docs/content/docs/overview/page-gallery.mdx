---
title: 页面功能图册
description: VenLinks PRO 用户端、公开页和管理后台的主要页面截图与功能说明
---
...
<div className="grid gap-6 lg:grid-cols-2">
  <figure>
    ...
    />
    <figcaption>
      <strong>首页</strong>：展示产品入口、公开内容和登录后的工作台跳转。
    </figcaption>
  </figure>
  <figure>
    <img
    ...
    />
    <figcaption>
      <strong>Agent 工作台</strong>：统一输入文字与参考素材，选择

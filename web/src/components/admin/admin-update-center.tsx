...
export function UpdateCenterPanel() {
    const releaseLinks = [
        { label: "Release", href: "https://github.com/csyqlz/VenLinks/releases", description: "查看正式版本包和升级说明" },
        { label: "Issues", href: "https://github.com/csyqlz/VenLinks/issues", description: "提交问题、部署异常和功能建议" },
        { label: "Docs", href: "https://github.com/csyqlz/VenLinks", description: "查看开源仓库与部署入口" },
    ];
                    ...
                    <div className="overflow-hidden rounded-3xl border border-stone-200/80 bg-stone-950 text-white shadow-sm shadow-stone-950/10 dark:border-stone-800 dark:bg-white dark:text-stone-950">
                        <div className="grid gap-3 p-4 sm:gap-6 sm:p-6 lg:grid-cols-[minmax(0,1fr)_220px]">
                            <div className="min-w-0">
                                <div className="text-xs font-semibold uppercase tracking-[0.16em] text-white/55 dark:text-stone-500">VenLinks Update</div>
                                ...
                                <div className="mt-3 grid grid-cols-2 gap-2 sm:mt-5 sm:flex sm:flex-wrap">
                                    ...
                                    <a
                                        href="https://github.com/csyqlz/VenLinks/releases"
                                        target="_blank"
                                        rel="noreferrer"

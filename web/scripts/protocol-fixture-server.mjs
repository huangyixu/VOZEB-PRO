...
if (import.meta.url === pathToFileURL(process.argv[1] || "").href) {
    const port = Number(process.env.VENLINKS_PROTOCOL_FIXTURE_PORT) || 4010;
    const host = process.env.VENLINKS_PROTOCOL_FIXTURE_HOST || "127.0.0.1";
    const fixture = createProtocolFixtureServer({ videoPath: process.env.VENLINKS_PROTOCOL_FIXTURE_VIDEO, responseDelayMs: process.env.VENLINKS_PROTOCOL_FIXTURE_DELAY_MS, failImage: process.env.VENLINKS_PROTOCOL_FIXTURE_FAIL_IMAGE === "1" });

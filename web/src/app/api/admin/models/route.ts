...
const globalCooldownStore = globalThis as typeof globalThis & { __venLinksModelFetchCooldowns?: Map<string, number> };
const modelFetchCooldowns = (globalCooldownStore.__venLinksModelFetchCooldowns ??= new Map<string, number>());

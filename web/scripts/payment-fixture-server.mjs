...
if (import.meta.url === pathToFileURL(process.argv[1] || "").href) {
    const port = Number(process.env.VENLINKS_PRO_PAYMENT_FIXTURE_PORT) || 4020;
    const host = process.env.VENLINKS_PRO_PAYMENT_FIXTURE_HOST || "127.0.0.1";
    const fixture = createPaymentFixtureServer({ alipayPrivateKey: process.env.VENLINKS_PRO_PAYMENT_FIXTURE_ALIPAY_PRIVATE_KEY });

...
const globalCooldownStore = globalThis as typeof globalThis & { __venLinksProModelFetchCooldowns?: Map<string, number> };
const modelFetchCooldowns = (globalCooldownStore.__venLinksProModelFetchCooldowns ??= new Map<string, number>());
